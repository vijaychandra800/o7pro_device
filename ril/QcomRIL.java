 ...
 * {@hide}
 */
public class QcomRIL extends RIL {
    ...
    public QcomRIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        super(context, preferredNetworkType, cdmaSubscription, null);
    }

    public QcomRIL(Context context, int preferredNetworkType,
