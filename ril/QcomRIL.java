...
/**
 * RIL customization for Samsung QcomRIL devices
 *
 * {@hide}
 */
public class QcomRIL extends RIL implements CommandsInterface {
    ...
    public QcomRIL(Context context, int networkMode, int cdmaSubscription,Integer instanceId) {
